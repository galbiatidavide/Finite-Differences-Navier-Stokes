...
static PetscErrorCode FirstShiftU_y(DM dmSol, Vec *pUShifted, Vec solRef) //ok
{
    ...
    //PetscObjectDestroy((PetscObject*)&coordLocal);
...
static PetscErrorCode FirstShiftU_z(DM dmSol, Vec *pUShifted, Vec solRef) //ok
{
    ...
    //PetscObjectDestroy((PetscObject*)&dmCoord);
    PetscObjectDestroy((PetscObject*)&l);
...
static PetscErrorCode FirstDerive_y_try(DM dmSol, Vec &AB_y, Vec AB)
{
    Vec             AB_local;
    ...
    DMGlobalToLocalEnd(dmSol,AB_y,INSERT_VALUES, AB_local);
...
static PetscErrorCode FirstDerive_y(DM dmSol, Vec *pAB_y, Vec AB)
{
    ...
    PetscFunctionBeginUser;
    PetscObjectDestroy((PetscObject*)pAB_y);
    AB_y = *pAB_y;
        PetscObjectDestroy((PetscObject*)pAB_y);
...
static PetscErrorCode ManageAdvectionLeak_first(Vec* U_int, Vec U_n, PetscInt nx, PetscInt ny, PetscInt nz, PetscScalar Lx_0, PetscScalar Lx, PetscScalar Ly_0, PetscScalar Ly, PetscScalar Lz_0, PetscScalar Lz)
{
...
// Assembling advection term
static PetscErrorCode ManageAdvection_second(PetscScalar dt, Vec U_n, Vec V_n, PetscInt nx, PetscInt ny, PetscInt nz, PetscScalar Lx_0, PetscScalar Lx, PetscScalar Ly_0, PetscScalar Ly, PetscScalar Lz_0, PetscScalar Lz)
{
    ...
    // Managing first mixed non-linear term, please DO NOT remove any comment
    {
        ...
        FirstDerive_y_try(dmSol_Shifted, UV_y, UV);
...
static PetscErrorCode ManagePressure(PetscScalar dt, Vec* pP, Vec* pP_x, Vec*  pP_y, Vec* pP_z, Vec U_n, Vec V_n, Vec W_n, PetscInt nx, PetscInt ny, PetscInt nz, PetscScalar Lx_0, PetscScalar Lx, PetscScalar Ly_0, PetscScalar Ly, PetscScalar Lz_0, PetscScalar Lz)
{
    ...
    PetscObjectDestroy((PetscObject*)&pc);
    ;
...
int main(int argc, char **argv)
{
    ...
    for(size_t i = 0; i < 1; ++i){
        if(i == 0){
            ...
            //ManageAdvection_second(dt, U_0, V_0, nx, ny, nz, Lx_0, Lx, Ly_0, Ly, Lz_0, Lz);
            ...
            DMStagVecSplitToDMDA(dmSol_Staggered, V_up, DOWN, 0, &da_solution_P, &P_grid);



            PetscObjectSetName((PetscObject)P_grid, "Vf");


            PetscViewerVTKOpen(PetscObjectComm((PetscObject)da_solution_P), "Vf.vtr", FILE_MODE_WRITE, &viewer_P);
