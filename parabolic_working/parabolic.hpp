...
public:
    parabolic_problem_x(ProblemSetting<Parabolic> const & parabolic, Vec const & U_0):
    Re(1.0/parabolic.mu), dt(parabolic.dt), iter(parabolic.iter), dmGrid(parabolic.dmGrid)
    {
...
public:
    parabolic_problem_y(ProblemSetting<Parabolic> const & parabolic, Vec const & V_0):
    Re(1.0/parabolic.mu), dt(parabolic.dt), iter(parabolic.iter), dmGrid(parabolic.dmGrid)
    {
        DMCreateMatrix(dmGrid, &A);
        DMCreateGlobalVector(dmGrid, &rhs);
...
public:
    parabolic_problem_z(ProblemSetting<Parabolic> const & parabolic, Vec const & W_0):
    Re(1.0/parabolic.mu), dt(parabolic.dt), iter(parabolic.iter), dmGrid(parabolic.dmGrid)
    {
        DMCreateMatrix(dmGrid, &A);
        DMCreateGlobalVector(dmGrid, &rhs);
