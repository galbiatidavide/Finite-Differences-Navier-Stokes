...
PetscInt constexpr nx{20};
PetscInt constexpr ny{20};
PetscInt constexpr nz{20};
PetscReal constexpr Lx_0{-0.1};
PetscReal constexpr Ly_0{0.2};
PetscReal constexpr Lz_0{-0.1};

PetscReal constexpr Lx{0.5};
PetscReal constexpr Ly{0.9};
PetscReal constexpr Lz{0.5};

//Define the time
PetscReal constexpr dt{0.0001};
PetscReal constexpr iter{100};

//Define flow parameters
PetscReal constexpr A{4*sqrt(2)/(3*sqrt(3))};
PetscReal constexpr k{2*pi/0.02};
PetscReal constexpr c{(5/6)*pi};
PetscReal constexpr d{(1/6)*pi};
PetscReal constexpr vNorm{1e-3*(1/A)};
//PetscReal constexpr vRef{vNorm*A};
PetscReal constexpr vRef = 0.1;
...
PetscErrorCode CreateAnalyticalU(DM const & dmGrid, Vec & vec, Vec const & penalization_U, PetscReal const & theta)
{
    PetscInt        start[3], n[3], nExtra[3], ex, ey, ez, iux, icux[3];
    DM              dmCoord;
    Vec             vecLocal, coord, coordLocal, penalizationLocal;
    PetscReal ****arrVec, ****arrCoord, ****arrPenalization;
...
PetscErrorCode CreateAnalyticalV(DM const & dmGrid, Vec & vec, Vec const & penalization_V, PetscReal const & theta)
{
...
PetscErrorCode CreateAnalyticalW(DM const & dmGrid, Vec & vec, Vec const & penalization_W, PetscReal const & theta)
{
