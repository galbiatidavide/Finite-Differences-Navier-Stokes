#include "transport.hpp"
    ...
    PetscErrorCode transport_problem_x::FirstShiftU_y(Vec & UShifted, Vec const & vec, PetscScalar const & theta) //okok
    {
        PetscFunctionBegin;
        Vec coordLocal;
    ...
    PetscErrorCode transport_problem_x::FirstShiftU_z(Vec & UShifted, Vec const & vec, PetscScalar const & theta) //okok
    {
        PetscFunctionBegin;
        Vec coordLocal;
    ...
    PetscErrorCode transport_problem_x::FirstShiftV_y(Vec & VShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
    ...
    PetscErrorCode transport_problem_x::FirstShiftW_z(Vec & WShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBegin;
        Vec coordLocal;
    ...
    PetscErrorCode transport_problem_x::FirstDerive_y(Vec & AB_y, Vec const & AB) //ok
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_x::FirstDerive_z(Vec & AB_z, Vec const & AB) //ok
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_x::CenterU(Vec & UCenter, Vec const & vec, PetscReal const & theta)
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_x::Derive_x(Vec & U2_x, Vec const & vec, PetscReal const & theta)
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_y::FirstShiftU_y(Vec & UShifted, Vec const & vec, PetscScalar const & theta) //okok
    {
        PetscFunctionBegin;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, right, up_right, down_left, up_left, left, down_right;
    ...
    PetscErrorCode transport_problem_y::FirstShiftU_z(Vec & UShifted, Vec const & vec, PetscScalar const & theta) //okok
    {
        PetscFunctionBegin;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, right, front_right, back_left, front_left, back_right, left;
    ...
    PetscErrorCode transport_problem_y::FirstShiftV_y(Vec & VShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBeginUser;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, up, up_right, down_left, up_left, down_right, down;
    ...
    PetscErrorCode transport_problem_y::FirstShiftW_z(Vec & WShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBegin;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, front, front_right, back_left, front_left, back_right, back;
    ...
    PetscErrorCode transport_problem_y::SecondShiftV_z(Vec & VShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBegin;
        Vec coordLocal;
    ...
    PetscErrorCode transport_problem_y::SecondShiftW_z(Vec & WShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBeginUser;
        Vec coordLocal;
    ...
    PetscErrorCode transport_problem_y::SecondDerive_x(Vec & AB_x, Vec const & AB) //ok
    {
        PetscFunctionBeginUser;
    ...
    PetscErrorCode transport_problem_y::SecondDerive_z(Vec & AB_z, Vec const & AB) //ok
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_y::CenterV(Vec & VCenter, Vec const & vec, PetscReal const & theta) 
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_y::Derive_y(Vec & V2_y, Vec const & vec, PetscReal const & theta)
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_z::FirstShiftU_y(Vec & UShifted, Vec const & vec, PetscScalar const & theta) //okok
    {
        PetscFunctionBegin;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, right, up_right, down_left, up_left, left, down_right;
    ...
    PetscErrorCode transport_problem_z::FirstShiftU_z(Vec & UShifted, Vec const & vec, PetscScalar const & theta) //okok
    {
        PetscFunctionBegin;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, right, front_right, back_left, front_left, back_right, left;
    ...
    PetscErrorCode transport_problem_z::FirstShiftV_y(Vec & VShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBeginUser;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, up, up_right, down_left, up_left, down_right, down;
    ...
    PetscErrorCode transport_problem_z::FirstShiftW_z(Vec & WShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBegin;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, front, front_right, back_left, front_left, back_right, back;
    ...
    PetscErrorCode transport_problem_z::SecondShiftV_z(Vec & VShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBegin;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, up, front_up, back_down, front_down, back_up, down;
    ...
    PetscErrorCode transport_problem_z::SecondShiftW_z(Vec & WShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        PetscFunctionBeginUser;
        Vec coordLocal;
        PetscInt startx, starty, startz, N[3], nx, ny, nz, ex, ey, ez, d, front, front_up, back_down, front_down, back_up, back;
    ...
    PetscErrorCode transport_problem_z::ThirdDerive_x(Vec & AB_x, Vec const & AB) //ok
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_z::ThirdDerive_y(Vec & AB_y, Vec const & AB) //ok
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_z::CenterW(Vec & WCenter, Vec const & vec, PetscReal const & theta) 
    {
        PetscFunctionBegin;
    ...
    PetscErrorCode transport_problem_z::Derive_z(Vec & W2_z, Vec const & vec, PetscReal const & theta)
    {
        PetscFunctionBegin;
