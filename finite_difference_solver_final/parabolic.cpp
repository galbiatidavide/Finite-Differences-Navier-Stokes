...
PetscErrorCode parabolic_problem_x::dump(size_t const & i)
{
    PetscFunctionBegin;
    ...
    char filename_u[50]; 
    sprintf(filename_u, "/media/dave/dave_data/results/x_component%03zu.vtr", i);
...
PetscErrorCode parabolic_problem_y::dump(size_t const & i)
{
    PetscFunctionBegin;
...
PetscErrorCode parabolic_problem_z::dump(size_t const & i)
{
    PetscFunctionBegin;
