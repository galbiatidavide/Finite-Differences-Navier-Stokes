...
static PetscScalar solution(PetscScalar x, PetscScalar y, PetscScalar z)
{
    ...
    return  3*pi*pi*cos(pi*x)*cos(pi*y)*cos(pi*z) + cos(pi*x)*cos(pi*y)*cos(pi*z);
}
...
int main(int argc, char **argv)
{
    ...
    static PetscInt nx  = 100;
    static PetscInt ny  = 100;
    static PetscInt nz  = 100;
