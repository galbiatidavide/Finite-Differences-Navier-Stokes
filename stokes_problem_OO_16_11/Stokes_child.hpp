...
parabolic_problem_x(U_0_, dmGrid_Staggered_x, Re, dt, iter),
parabolic_problem_y(V_0_, dmGrid_Staggered_y, Re, dt, iter),
parabolic_problem_z(W_0_, dmGrid_Staggered_z, Re, dt, iter),
