...
{   
    ...
    DM dmGrid_Staggered_x, dmGrid_Staggered_y, dmGrid_Staggered_z;
    {
    ...
    ProblemSetting<Parabolic> parabolic(nx, ny, nz, Lx_0, Ly_0,  Lz_0, Lx,  Ly,  Lz, dt,  iter, 1.0/Re);

    parabolic_problem_x parabolic_x(parabolic, U_0);
...
/*
{
    ...
    parabolic_problem_y parabolic_y(parabolic, V_0);
...
/*{
    ...
    parabolic_problem_z parabolic_z(parabolic, W_0);
