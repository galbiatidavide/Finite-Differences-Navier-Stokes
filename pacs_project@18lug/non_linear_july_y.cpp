...
int main(int argc, char **argv)
{
    ...
    static PetscInt nx  = 20;
    static PetscInt ny  = 20;
    static PetscInt nz  = 20;
    ...
    ManageAdvection(dt, &U_int, &V_int, &W_int, U_0, V_0, W_0, nx, ny, nz, Lx_0, Lx, Ly_0, Ly, Lz_0, Lz);
        ...
        Vec my_bench;
    CreateReferenceSolutionTry(dmSol_Staggered_y, &my_bench);
    CheckSolution(V_int, my_bench);     // Assembling whole non-linear
