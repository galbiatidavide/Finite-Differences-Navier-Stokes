...
int main(int argc, char **argv)
{
    ...
    //io allocherei dei DMGlobal per U_pre, V_pre, W_pre.
    ...
    /*for(size_t i = 0; i < 9; i++){
        if (i == 0){
            ...
            ManageViscosity(dt, Re, &U_pre, &V_pre, &W_pre, U_pre, V_pre, W_pre, nx, ny, nz, Lx_0, Lx, Ly_0, Ly, Lz_0, Lz);}
    }*/
