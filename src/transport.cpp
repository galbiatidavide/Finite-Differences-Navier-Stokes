...
transport_problem_x::transport_problem_x(DM const & dmGrid_Shifted, DM const & dmGrid_Staggered, DM const & dmGrid_Centered) :
...
transport_problem_y::transport_problem_y(DM const & dmGrid_Shifted, DM const & dmGrid_Staggered, DM const & dmGrid_Centered) :
dmGrid_Shifted(dmGrid_Shifted), dmGrid_Staggered(dmGrid_Staggered), dmGrid_Centered(dmGrid_Centered)
{
    DMCreateGlobalVector(dmGrid_Staggered, &U_n);
    DMCreateGlobalVector(dmGrid_Staggered, &V_n);
...
transport_problem_z::transport_problem_z(DM const & dmGrid_Shifted, DM const & dmGrid_Staggered, DM const & dmGrid_Centered) :
dmGrid_Shifted(dmGrid_Shifted), dmGrid_Staggered(dmGrid_Staggered), dmGrid_Centered(dmGrid_Centered)
{
    DMCreateGlobalVector(dmGrid_Staggered, &U_n);
    DMCreateGlobalVector(dmGrid_Staggered, &V_n);
