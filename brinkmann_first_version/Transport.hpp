...
protected:
    ...
    PetscErrorCode const FirstShiftU_y(Vec & UShifted, Vec const & vec, PetscScalar const & theta) //okok
    {
        ...
        DMCreateLocalVector(dmGrid_Staggered, &penalizationLocal);
        DMGlobalToLocalBegin(dmGrid_Staggered, penalization_u, INSERT_VALUES, penalizationLocal);
        DMGlobalToLocalEnd(dmGrid_Staggered, penalization_u, INSERT_VALUES, penalizationLocal);
        DMStagVecGetArrayRead(dmGrid_Staggered, penalizationLocal, &arrPenalization);
        ...
        for (ez = startz; ez < startz + nz; ++ez) {
            for (ey = starty; ey < starty + ny; ++ey) {
                for (ex = startx; ex < startx + nx; ++ex) {
                    ...
                    if (ey == 0) {
                        if(arrPenalization[ez][ey][ex][left] == 0.0) {
                            ...
                            arrUShifted_local[ez][ey][ex][down_left] = 0.0;
                        }
                    ...
                    if (ex == 0) {   
                        if(arrPenalization[ez][ey][ex][left] == 0.0) {
                            ...
                            arrUShifted_local[ez][ey][ex][up_left] = 0.0;
                        }                 
                    }

                    if (ey == N[1] - 1) {
                        if(arrPenalization[ez][ey][ex][right] == 0.0) {
                            ...
                            arrUShifted_local[ez][ey][ex][up_right] = 0.0;
                        }
                    }
                    ...
                    if (ex == N[0] - 1) {
                        if(arrPenalization[ez][ey][ex][right] == 0.0) {
                            ...
                            arrUShifted_local[ez][ey][ex][down_right] = 0.0;
                        }
                    }
                }
            }
        ...
        DMStagVecRestoreArrayRead(dmGrid_Staggered, penalizationLocal, &arrPenalization);
        DMRestoreLocalVector(dmGrid_Staggered, &penalizationLocal);
                ...
                for (ex = startx; ex < startx + nx; ++ex) {
                    ...
                    if (ez == 0) {
                        if(arrPenalization[ez][ey][ex][left] == 0.0) {
                            ...
                            arrUShifted_local[ez][ey][ex][back_left] = 0.0;
                        }
                    }
                    ...
                    if (ez == N[2] - 1) {
                        if(arrPenalization[ez][ey][ex][right] == 0.0) {
                            ...
                            arrUShifted_local[ez][ey][ex][front_right] = 0.0;
                        }
                    }
                    ...
                    if (ex == N[0] - 1) {
                        if(arrPenalization[ez][ey][ex][right] == 0.0) {
                            ...
                            arrUShifted_local[ez][ey][ex][back_right] = 0.0;
                        }
                    }
                }
            }
    ...
    PetscErrorCode const FirstShiftV_y(Vec & VShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        ...
        PetscReal ****arrPenalization;
        DMCreateLocalVector(dmGrid_Staggered, &penalizationLocal);
        DMGlobalToLocalBegin(dmGrid_Staggered, penalization_v, INSERT_VALUES, penalizationLocal);
        DMGlobalToLocalEnd(dmGrid_Staggered, penalization_v, INSERT_VALUES, penalizationLocal);
        DMStagVecGetArrayRead(dmGrid_Staggered, penalizationLocal, &arrPenalization);
        ...
        for (ez = startz; ez < startz + nz; ++ez) {
            for (ey = starty; ey < starty + ny; ++ey) {
                for (ex = startx; ex < startx + nx; ++ex) {
                    ...
                    if (ey == 0) {
                        if(arrPenalization[ez][ey][ex][down] == 0.0) {
                            ...
                            arrVShifted_local[ez][ey][ex][down_left] = 0.0;
                        }
                    }

                    if (ex == 0) {
                        if(arrPenalization[ez][ey][ex][up] == 0.0) {
                            ...
                            arrVShifted_local[ez][ey][ex][up_left] = 0.0;
                        }
                    }
                    ...
                    if (ey == N[1] - 1) {
                        if(arrPenalization[ez][ey][ex][up] == 0.0) {
                            ...
                            arrVShifted_local[ez][ey][ex][up_right] = 0.0;
                        }
                    }
                    ...
                    if (ex == N[0] - 1) {
                        if(arrPenalization[ez][ey][ex][down] == 0.0) {
                            ...
                            arrVShifted_local[ez][ey][ex][down_right] = 0.0;
                        }
    ...
    PetscErrorCode const FirstShiftW_z(Vec & WShifted, Vec const & vec, PetscScalar const & theta) //ok
    {
        ...
        PetscReal ****arrPenalization;
        DMCreateLocalVector(dmGrid_Staggered, &penalizationLocal);
        DMGlobalToLocalBegin(dmGrid_Staggered, penalization_w, INSERT_VALUES, penalizationLocal);
        DMGlobalToLocalEnd(dmGrid_Staggered, penalization_w, INSERT_VALUES, penalizationLocal);
        DMStagVecGetArrayRead(dmGrid_Staggered, penalizationLocal, &arrPenalization);
        ...
        for (ez = startz; ez < startz + nz; ++ez) {
            for (ey = starty; ey < starty + ny; ++ey) {
                for (ex = startx; ex < startx + nx; ++ex) {
                    ...
                    if (ez == 0) {
                        if(arrPenalization[ez][ey][ex][back] == 0.0) {
                            ...
                            arrWShifted_local[ez][ey][ex][back_left] = 0.0;
                        }  
                    }

                    if (ex == 0) {
                        if(arrPenalization[ez][ey][ex][front] == 0.0) {
                            ...
                            arrWShifted_local[ez][ey][ex][front_left] = 0.0;
                        }
                    }
                    ...
                    if (ez == N[2] - 1) {
                        if(arrPenalization[ez][ey][ex][front] == 0.0) {
                            ...
                            arrWShifted_local[ez][ey][ex][front_right] = 0.0;
                        }
                    }
                    ...
                    if (ex == N[0] - 1) {
                        if(arrPenalization[ez][ey][ex][back] == 0.0) {
                            ...
                            arrWShifted_local[ez][ey][ex][back_right] = 0.0;
                        }
                    }
                }
            }
...
public:
    ...
    transport_problem_x(ProblemSetting<Transport> const & setting, Vec const & U_0_, Vec const & V_0_, Vec const & W_0_, Vec const & penalization_u, Vec const & penalization_v, Vec const & penalization_w) : 
    ...
    iter(setting.iter), penalization_u(penalization_u), penalization_v(penalization_v), penalization_w(penalization_w)
    {
        ...
        Vec u;
        DMStagVecSplitToDMDA(dmGrid_Staggered, penalization_u, LEFT, 0, &DM_u, &u);
        PetscObjectSetName((PetscObject)u, "ciaotrans");
        char filename_u[50]; 
        sprintf(filename_u, "results/ciaotrans.vtr");
                ...
                for (ex = startx; ex < startx + nx; ++ex) {
                    ...
                    if (ey == 0) {
                        if(arrPenalization[ez][ey][ex][down] == 0.0) {
                            ...
                            arrVShifted_local[ez][ey][ex][front_down] = 0.0;
                        }
                    }
                    ...
                    if (ez == N[2] - 1) {
                        if(arrPenalization[ez][ey][ex][up] == 0.0) {
                            ...
                            arrVShifted_local[ez][ey][ex][front_up] = 0.0;
                        }
                    }
                    ...
                    if (ey == N[1] - 1) {
                        if(arrPenalization[ez][ey][ex][up] == 0.0) {
                            ...
                            arrVShifted_local[ez][ey][ex][back_up] = 0.0;
                        }
                    }
                    ...
                    if (ez == 0) {
                        if(arrPenalization[ez][ey][ex][down] == 0.0) {
                            ...
                            arrVShifted_local[ez][ey][ex][back_down] = 0.0;
                        }
                    }
                }
            }
                ...
                for (ex = startx; ex < startx + nx; ++ex) {
                    ...
                    if (ez == 0) {
                        if(arrPenalization[ez][ey][ex][back] == 0.0) {
                            ...
                            arrWShifted_local[ez][ey][ex][back_down] = 0.0;
                        }
                    }
                    ...
                    if (ey == 0) {
                        if(arrPenalization[ez][ey][ex][front] == 0.0) {
                            ...
                            arrWShifted_local[ez][ey][ex][front_down] = 0.0;
                        }
                    }
                    ...
                    if (ez == N[2] - 1) {
                        if(arrPenalization[ez][ey][ex][front] == 0.0) {
                            ...
                            arrWShifted_local[ez][ey][ex][front_up] = 0.0;
                        }
                    }
                    ...
                    if (ey == N[1] - 1) {
                        if(arrPenalization[ez][ey][ex][back] == 0.0) {
                            ...
                            arrWShifted_local[ez][ey][ex][back_up] = 0.0;
                        }
...
public:
    ...
    transport_problem_y(ProblemSetting<Transport> const & setting, Vec const & U_0_, Vec const & V_0_, Vec const & W_0_, Vec const & penalization_u, Vec const & penalization_v, Vec const & penalization_w) :
    dmGrid_Shifted(setting.dmGrid_Shifted), dmGrid_Staggered(setting.dmGrid_Staggered), dmGrid_Centered(setting.dmGrid_Centered), dt(setting.dt),
    iter(setting.iter), penalization_u(penalization_u), penalization_v(penalization_v), penalization_w(penalization_w)
    {
        DMCreateGlobalVector(dmGrid_Staggered, &U_0);
...
public:
    ...
    transport_problem_z(ProblemSetting<Transport> const & setting, Vec const & U_0_, Vec const & V_0_, Vec const & W_0_, Vec const & penalization_u, Vec const & penalization_v, Vec const & penalization_w) : 
    dmGrid_Shifted(setting.dmGrid_Shifted), dmGrid_Staggered(setting.dmGrid_Staggered), dmGrid_Centered(setting.dmGrid_Centered), dt(setting.dt),
    iter(setting.iter), penalization_u(penalization_u), penalization_v(penalization_v), penalization_w(penalization_w)
    {
        DMCreateGlobalVector(dmGrid_Staggered, &U_0);
