...
public:
    euler_problem(DM const & dmGrid_Staggered_x, DM const & dmGrid_Staggered_y, DM const & dmGrid_Staggered_z, DM const & dmGrid_Staggered, DM const & dmGrid_Centered, DM const & dmGrid_Shifted, Vec const & U_init, Vec const & V_init, Vec const & W_init) : 
    dmGrid_Staggered_x(dmGrid_Staggered_x), dmGrid_Staggered_y(dmGrid_Staggered_y), dmGrid_Staggered_z(dmGrid_Staggered_z), dmGrid_Staggered(dmGrid_Staggered), dmGrid_Centered(dmGrid_Centered), dmGrid_Shifted(dmGrid_Shifted)
    {
    ...
    PetscErrorCode solve()
    {
        ...
        for(size_t i = 0; i < iter; ++i){
            if (i == 0){
                ...
                ManagePressure(dmGrid_Centered, dmGrid_Shifted, dmGrid_Staggered, dt, P, U_int, V_int, W_int);
                ...
                UpdateVelocity(dmGrid_Staggered_x, dmGrid_Staggered_y, dmGrid_Staggered_z, dt, U_up, V_up, W_up, P_x, P_y, P_z, U_int, V_int, W_int, theta);
